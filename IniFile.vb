...
Public Class IniFile
    ...
    Public Sub Save(ByVal sFileName As String)
        ...
        'This is a hack for the moment. Ideally the comments are not directly in code. Maybe read from an embedded resource.
        oWriter.WriteLine(";")
        oWriter.WriteLine(";     Locked: INI file is loaded at program startup.")
        oWriter.WriteLine(";             Every new tab uses the same ping defaults.")
        oWriter.WriteLine(";             Settings are never saved to INI file by the program.")
        oWriter.WriteLine(";")
        oWriter.WriteLine(";      Fluid: INI file is loaded at program startup.")
        oWriter.WriteLine(";             Every new tab uses the defaults from the last active tab.")
        oWriter.WriteLine(";             Settings are never saved to INI file by the program.")
        oWriter.WriteLine(";")
        oWriter.WriteLine(";  Writeable: INI file is loaded at program startup.")
        oWriter.WriteLine(";             Every new tab uses the defaults from the last active tab.")
        oWriter.WriteLine(";             Settings of the active tab are saved back to the INI file at program close.")
